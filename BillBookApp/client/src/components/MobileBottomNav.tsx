...
const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ currentView, onChangeView, onFabClick }) => {
  ...
  return (
    <>
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 rounded-t-3xl shadow-xl z-50 overflow-hidden pb-10"
            >
              {/* Drag Handle */}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-surface-container dark:bg-surface-container-low border-t border-border/50 pb-10 z-30">
