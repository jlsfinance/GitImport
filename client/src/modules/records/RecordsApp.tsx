...
import NewEntry from './pages/NewEntry'; // fka Disbursal
...
import './records.css'; // Renamed from loan.css
...
const ProtectedRoute = ({ children }: { children?: React.ReactNode }) => {
    ...
    if (!user) {
        ...
        return <Navigate to="/records/customer-login" replace />;
    }
...
const RecordsAppContent = () => {
    ...
    // Route Prefixes updated to /records
    const isAuthRoute = ['/records/login', '/records/register', '/records/forgot-password', '/records/customer-login', '/records/customer-portal'].includes(location.pathname);
