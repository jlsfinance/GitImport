...
const UPLOAD_PRESET = "YOUR_UPLOAD_PRESET_HERE"; // Create an 'Unsigned' upload preset in Cloudinary Settings
...
const NewCustomer: React.FC = () => {
    ...
    const uploadPhoto = async (file: File): Promise<string> => {
        ...
        formData.append("folder", "buddy_photos");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (CLOUD_NAME === "YOUR_CLOUD_NAME_HERE") {
            alert("⚠️ Developer: Please set CLOUD_NAME in code!");
            return;
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <>Save Buddy <span className="material-symbols-outlined material-symbols-fill">check_circle</span></>
                        )}
                    </button>
                </form>
            </div>
