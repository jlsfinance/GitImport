    ...
    >
      <div className="w-full max-w-sm rounded-3xl bg-white dark:bg-surface-dark p-8 shadow-xl ring-1 ring-slate-900/5 dark:ring-white/10">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-2 mt-2 px-1">
            ...
            <label htmlFor="terms" className="text-xs text-slate-500 dark:text-slate-400 leading-tight select-none cursor-pointer">
              I agree to the <Link to="/records/terms" className="text-primary font-bold hover:underline">Terms of Service</Link> and <Link to="/records/privacy" className="text-primary font-bold hover:underline">Privacy Policy</Link>.
            </label>
          </div>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <Link to="/records/login" className="font-bold text-primary hover:underline">
            Sign In
          </Link>
        </div>
      </div>
