    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center px-6 pt-6 pb-2" style={{ paddingTop: 'calc(2rem + env(safe-area-inset-top))' }}>
                ...
                <Link to="/records/settings" className="p-2 -mr-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
            ...
            <div className="px-4 space-y-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <Link to="/records/tools/calculator" className="bg-white dark:bg-[#1e2736] p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-start gap-4 hover:shadow-md transition-all active:scale-95">
                        ...
                        <Link to="/records/all" className="bg-white dark:bg-[#1e2736] p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-start gap-4 hover:shadow-md transition-all active:scale-95">
                        ...
                        <Link to="/records/tools/payment-reminder" className="bg-white dark:bg-[#1e2736] p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-start gap-4 hover:shadow-md transition-all active:scale-95">
                        ...
                        <Link to="/records/customers" className="bg-white dark:bg-[#1e2736] p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-start gap-4 hover:shadow-md transition-all active:scale-95">
                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <Link to="/records/reports" className="flex items-center justify-between p-4 bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <Link to="/records/due-list" className="flex items-center justify-between p-4 bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <div className="flex items-center gap-4">
                                <div className="h-10 w-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 text-blue-600 flex items-center justify-center">
                        ...
                        <Link to="/records/due-list" className="flex items-center justify-between p-4 bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-sm">Overdue Records</h4>
                                    <p className="text-[10px] text-slate-500 font-medium">Action items</p>
                                </div>
                            </div>
                            <span className="material-symbols-outlined text-slate-300">chevron_right</span>
                        </Link>

                        <Link to="/records/approvals" className="flex items-center justify-between p-4 bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-sm">Pending Confirmation</h4>
                        ...
                        <Link to="/records/new-entry" className="flex items-center justify-between p-4 bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-sm">Pending Entries</h4>
                                    <p className="text-[10px] text-slate-500 font-medium">Accepted records ready to start</p>
                                </div>
                            </div>
                            <span className="material-symbols-outlined text-slate-300">chevron_right</span>
                        </Link>
