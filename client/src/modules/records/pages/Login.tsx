        ...
        <form onSubmit={handleLogin} className="w-full space-y-3">
          ...
          <div className="flex items-start gap-2 mt-1">
            ...
            <label htmlFor="terms" className="text-[10px] text-white/70 leading-tight">
              I agree to the <Link to="/records/terms" className="text-white font-bold hover:underline">Terms</Link> and <Link to="/records/privacy" className="text-white font-bold hover:underline">Privacy Policy</Link>.
            </label>
          </div>
