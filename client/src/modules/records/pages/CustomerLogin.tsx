    ...
    >
      ...
      <div className="w-full max-w-sm flex flex-col h-full justify-evenly">
        ...
        <div className="text-center pt-2">
          ...
          <p className="text-white/80 text-xs">View your records and pay installments</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1e2736] rounded-3xl shadow-2xl p-5 relative">
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="flex items-start gap-2 mt-1">
              ...
              <label htmlFor="terms" className="text-[10px] text-gray-600 dark:text-gray-400 leading-tight">
                I agree to the <Link to="/records/terms" className="text-blue-600 font-bold hover:underline">Terms</Link> & <Link to="/records/privacy" className="text-blue-600 font-bold hover:underline">Privacy</Link>.
              </label>
            </div>
          ...
          <div className="mt-4 text-center">
            ...
            <button
              ...
              className="mt-3 text-xs font-bold text-gray-400 hover:text-white transition-colors flex items-center justify-center gap-1 w-full"
            >
