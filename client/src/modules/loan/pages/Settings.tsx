...
const Settings: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* DISCLAIMER CARD - Play Store Compliance */}
      <div className="px-4 mt-6">
        <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/30 rounded-xl p-4">
          <div className="flex items-start gap-3">
            <span className="material-symbols-outlined text-yellow-600 dark:text-yellow-500 mt-1">warning</span>
            <div>
              <h3 className="text-sm font-bold text-yellow-800 dark:text-yellow-400">Disclaimer</h3>
              <p className="text-xs text-yellow-700 dark:text-yellow-500/80 mt-1 leading-relaxed">
                This application is a <strong>financial record management tool only</strong>.
                It does not provide loans, financial services, approvals, or advice.
                All data shown is entered and managed by the user.
              </p>
            </div>
          </div>
        </div>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-[#1e2736] rounded-[28px] w-full max-w-sm shadow-2xl p-6 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center mb-6 mt-2">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
                Permanent data removal process
              </p>
            </div>

            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 mb-6 text-left">
              <p className="text-sm text-slate-700 dark:text-slate-300 mb-4 leading-relaxed">
                To delete your account and all associated data, please send an email from your registered address to:
              </p>

              <div className="bg-white dark:bg-black/20 border border-slate-200 dark:border-slate-700 rounded-lg p-3 mb-4 select-text">
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Send Email To:</p>
                <p className="font-mono text-primary font-bold break-all select-all">lovneetrathi@gmail.com</p>
              </div>

              <div className="bg-white dark:bg-black/20 border border-slate-200 dark:border-slate-700 rounded-lg p-3 select-text">
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Subject:</p>
                <p className="font-mono text-slate-700 dark:text-slate-300 font-bold select-all">Delete My Account</p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <p className="text-xs text-slate-400 uppercase tracking-wider mb-1">Support Contact:</p>
                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">+91 94138 21007</p>
              </div>
            </div>

            <button
              onClick={() => setShowDeleteModal(false)}
              className="w-full bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white font-bold py-3.5 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
            >
              Start Email
            </button>
            <button
              onClick={() => setShowDeleteModal(false)}
              className="w-full mt-3 text-sm text-slate-500 font-medium py-2"
            >
              Cancel
            </button>
          </div>
