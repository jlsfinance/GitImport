          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="flex items-start gap-2 mt-1">
              ...
              <label htmlFor="terms" className="text-[10px] text-gray-600 dark:text-gray-400 leading-tight">
                I agree to the <Link to="/loan/terms" className="text-blue-600 font-bold hover:underline">Terms</Link> & <Link to="/loan/privacy" className="text-blue-600 font-bold hover:underline">Privacy</Link>.
              </label>
            </div>
