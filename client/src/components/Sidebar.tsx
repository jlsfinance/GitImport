...
import { LayoutDashboard, FileText, Users, Package, Receipt, Settings, Cloud, CloudOff, LogOut, ArrowDownLeft, Sun, Moon, X, ArrowLeftRight, ShoppingBag } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, isCloudConnected = false, onClose }) => {
  ...
  const navItems = [
    ...
    { id: ViewState.INVOICES, label: 'Sales (Invoices)', icon: FileText },
    { id: ViewState.PURCHASES, label: 'Purchases', icon: ShoppingBag },
    { id: ViewState.CUSTOMERS, label: 'Parties & Ledger', icon: Users },
    { id: ViewState.INVENTORY, label: 'Inventory (Stock)', icon: Package },
    { id: ViewState.EXPENSES, label: 'Expenses', icon: Receipt },
    { id: ViewState.PAYMENTS, label: 'Payments / Receipts', icon: ArrowDownLeft },
