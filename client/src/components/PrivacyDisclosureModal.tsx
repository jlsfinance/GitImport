                    ...
                    >
                        ...
                        <div className="p-8 space-y-6 max-h-[60vh] overflow-y-auto">
                            <div className="space-y-4">
                                ...
                                <section>
                                    <h3 className="text-sm font-black text-foreground uppercase tracking-wider mb-2">2. No Contact Access</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Respecting your privacy, <strong>we do not access your device contacts</strong>. You must manually enter customer details to create records.
                                    </p>
                                </section>
