 ...
 * (Uses neutral terminology for Google Play compliance)
 */
export async function sendInstallmentReminderNotification(
    ...
    return sendPushNotification(
        customerFcmToken,
        'Record Update', // Neutral title
        `Dear ${customerName}, your scheduled installment of ₹${amount.toLocaleString('en-IN')} is due on ${dueDate}. Please check your record.`,
        {
            type: 'inst_reminder',
            recordId,
...
/**
 * Helper: Send overdue record alert to admin
 * (Uses neutral terminology for Google Play compliance)
 */
export async function sendOverdueAlertToAdmin(
    ...
    return sendPushNotification(
        adminFcmToken,
        'Record Update Alert', // Neutral title
        `${customerName}'s installment of ₹${amount.toLocaleString('en-IN')} is ${daysPastDue} days past due date.`,
        {
            type: 'overdue_alert',
            recordId,
            customerName,
