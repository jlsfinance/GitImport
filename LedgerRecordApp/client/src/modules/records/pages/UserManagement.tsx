              ...
              {editedRole === 'agent' && (
                <div className="space-y-2 border-t border-slate-100 dark:border-slate-800 pt-4">
                  ...
                  <label className="flex items-center gap-3 p-2 rounded hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={editedPermissions.canViewRecords}
                      onChange={(e) => setEditedPermissions(p => ({ ...p, canViewRecords: e.target.checked }))}
                      className="rounded border-slate-300 text-primary focus:ring-primary h-4 w-4"
                    />
                  ...
                  <label className="flex items-center gap-3 p-2 rounded hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={editedPermissions.canCollectPayments}
                      onChange={(e) => setEditedPermissions(p => ({ ...p, canCollectPayments: e.target.checked }))}
                      className="rounded border-slate-300 text-primary focus:ring-primary h-4 w-4"
                    />
              ...
              {newStaffRole === 'agent' && (
                <div className="space-y-2 border-t border-slate-100 dark:border-slate-800 pt-4">
                  ...
                  <label className="flex items-center gap-3 p-2 rounded hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={newStaffPermissions.canViewRecords}
                      onChange={(e) => setNewStaffPermissions(p => ({ ...p, canViewRecords: e.target.checked }))}
                      className="rounded border-slate-300 text-primary focus:ring-primary h-4 w-4"
                    />
                    <span className="text-sm">Can View Records</span>
                  </label>
                  <label className="flex items-center gap-3 p-2 rounded hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={newStaffPermissions.canCollectPayments}
                      onChange={(e) => setNewStaffPermissions(p => ({ ...p, canCollectPayments: e.target.checked }))}
                      className="rounded border-slate-300 text-primary focus:ring-primary h-4 w-4"
                    />
                    <span className="text-sm">Can Collect Payments</span>
                  </label>
