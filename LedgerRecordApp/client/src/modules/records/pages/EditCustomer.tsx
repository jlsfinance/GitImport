...
const EditCustomer: React.FC = () => {
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    setFormData({
                        ...
                        guarantorMobile: data.guarantor?.mobile || '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            let photoUrl = photoPreview; // Keep existing if no new file
            if (photoFile) {
    ...
    if (loading) {
        return <div className="flex h-screen items-center justify-center"><div className="h-8 w-8 animate-spin rounded-full border-2 border-primary border-t-transparent"></div></div>;
    }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-[#1e2736] rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                        ...
                        <div className="p-6 flex flex-col sm:flex-row gap-6 items-center">
                            ...
                            <div className="flex-1 w-full">
                                <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Change Photo</label>
                                <input
                                    type="file"
                                    accept="image/*"
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <>Update Details <span className="material-symbols-outlined">save</span></>
                        )}
                    </button>
                </form>
            </div>
